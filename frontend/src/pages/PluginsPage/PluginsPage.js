            ...
            <CardContent >
                <Grid container alignItems="center" justifyContent="center">
                    <img
                        src={logo}
                        alt="Logo"
                        style={{ width: "70px", height: "70px", alignContent: "center", borderRadius: "50%" }}
                    />
                </Grid>

                <Typography sx={{ fontSize: 16 }} color="text.primary" gutterBottom align="center" marginTop={2}>
                    Apple iphone X
                </Typography>
    ...
    return (
        <>
            ...
            <Container style={containerStyle}>
                <Typography variant="h4" color="textPrimary" align="center" marginTop={3}>
                    EM Plugins
                </Typography>
                ...
                <Grid container spacing={0} alignItems="center" justifyContent="center" marginTop={4}>

                    <Grid xs={5} sm={5} md={2} marginTop={8} m={2}>
                        <Box sx={{
                            minWidth: 200, maxWidth: 200, boxShadow: 4, borderRadius: '6px', '&:hover': {
                                boxShadow: '0px 0px 10px rgba(0,36,90, 1)',
                            },
                        }} >
                            <Card variant="outlined" onClick={handleClickOpen}>{card1} </Card>
                        </Box>
                    </Grid>
                    <Grid xs={5} sm={5} md={2} marginTop={8} m={2}>
                        <Box sx={{
